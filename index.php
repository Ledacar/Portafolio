...
<head>
    ...
    <link rel="icon" href="./static/png/943026.png">
    ...
    <section class="home" id="homes">
        <div class="max-width">
            <div class="home-conten">
                <div class="text-1">Hola, mundo</div>
                <div class="text-2">Soy Carlos</div>
                <div class="text-3">Yo soy <span class="typing">Ingeniero en sistemas</span></div>
            </div>
        </div>
    </section>
        ...
        <div class="max-width">
            ...
            <div class="about-conten">
                ...
                <div class="column right">
                    ...
                    <p>
                        Soy una persona responsable, amables con ganas de siempre salir adelanta y ganas de
                        siempre aprender un poco mas sobre la informatica.
                    </p>
